...
const appState = {
    ...
    books: JSON.parse(localStorage.getItem('lib_books')) || [
        { id: 101, title: "Ismaaciil Mire", author: "Ismaaciil Mire", price: 2.00, totalCopies: 5, borrowed: 1, cover: "Ismaaciil-Mire-Gabyaagii-Halgamaaga-Ahaa.avif" },
        { id: 102, title: "Aqoondarro Waa U Nacab Jacayl", author: "Faarax M.J. Cawl", price: 4.00, totalCopies: 4, borrowed: 0, cover: "aqoon dare waa oo naceb jacel.jpg" },
        { id: 103, title: "Maana-faay", author: "Maxamed Daahir Afrax", price: 3.50, totalCopies: 5, borrowed: 1, cover: "maana faay.jpg" },
        { id: 104, title: "Maaweelo & Dhaqan", author: "C. C. Gardaad", price: 1.50, totalCopies: 5, borrowed: 1, cover: "maaweelo&dhaqan.jpg" },
        { id: 105, title: "Taariikhda Geeska Afrika", author: "Cabdullaahi Sh. Axmad", price: 3.00, totalCopies: 0, borrowed: 0, cover: "Taariikhda Geeska Afrika.jpg" },
        { id: 106, title: "Suugaanta Soomaalida", author: "Axmed F. Cali 'Idaajaa'", price: 2.50, totalCopies: 4, borrowed: 0, cover: "Suugaanta Soomaalida.jpg" },
        { id: 107, title: "Hagarlaawe", author: "Maxamed Xaashi Dhamac 'Gaarriye'", price: 2.00, totalCopies: 5, borrowed: 0, cover: "Hagarlaawe.jfif" },
        { id: 108, title: "Qalin iyo Qorshe", author: "Muxammad Yuusuf", price: 3.00, totalCopies: 5, borrowed: 0, cover: "Qalin iyo Qorshe.jpg" },
        { id: 109, title: "Sheekooyin Dhaqan Soomaaliyeed", author: "Cumar Maxamed Cumar", price: 2.50, totalCopies: 3, borrowed: 0, cover: "sheekooyin_dhaqan.png" }
    ],
...
// Data Migration: Force-update book covers to ensure they match current filenames
function migrateBookData() {
    const coverMap = {
        "Ismaaciil Mire": "Ismaaciil-Mire-Gabyaagii-Halgamaaga-Ahaa.avif",
        "Aqoondarro Waa U Nacab Jacayl": "aqoon dare waa oo naceb jacel.jpg",
        "Maana-faay": "maana faay.jpg",
        "Maaweelo & Dhaqan": "maaweelo&dhaqan.jpg",
        "Taariikhda Geeska Afrika": "Taariikhda Geeska Afrika.jpg",
        "Suugaanta Soomaalida": "Suugaanta Soomaalida.jpg",
        "Hagarlaawe": "Hagarlaawe.jfif",
        "Qalin iyo Qorshe": "Qalin iyo Qorshe.jpg",
        "Sheekooyin Dhaqan Soomaaliyeed": "sheekooyin_dhaqan.png"
    };

    let updated = false;
    appState.books.forEach(book => {
        // Force update the cover even if one exists, to fix wrong paths
        if (coverMap[book.title]) {
            if (book.cover !== coverMap[book.title]) {
                book.cover = coverMap[book.title];
                updated = true;
            }
        }
    });
    ...
    if (updated) {
        saveState();
        console.log("Book covers migrated successfully.");
    }
}
